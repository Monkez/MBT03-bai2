...
- Ngày 2026-09-13, `test.bat` đạt 116/116. Kiểm tra tích hợp localhost xác nhận ba kênh control/stream/shoot-data, handshake và dữ liệu hai chiều đều thành công; entry point demo có smoke test riêng.
